    ...
    <div className="reading-shell">
      <header className="grid gap-10 border-b border-[var(--line-strong)] pb-12 pt-12 lg:grid-cols-[13rem_1fr] lg:pb-16 lg:pt-20">
        <div>
          ...
          <div className="mt-5 flex items-center gap-2 text-xs text-[var(--ink-muted)]"><Clock3 aria-hidden="true" className="size-3.5" /> {lesson.duration} min</div>
